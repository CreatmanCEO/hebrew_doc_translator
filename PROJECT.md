...
> **⚠️ Статус-заметка (2026-06-01, Phase 0).** Этот документ — историческая
> спецификация и местами расходится с актуальной реализацией. Актуальные источники
> истины: [README.md](./README.md), [CHANGELOG.md](./CHANGELOG.md) и
> `docs/plans/2026-06-01-hebrew-translator-production-design.md`. Ключевые отличия:
> перевод идёт через **LiteLLM (Claude/Gemini), без OpenAI и без Azure**; в Phase 0
> реконструкция — текстового уровня (полная вёрстка DOCX/PDF и OCR — на роадмапе);
